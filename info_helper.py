...
class InformationHelper:
    ...
    def parse_nutrients(self, nutrients):
        main = ["ENERC_KCAL", "FAT", "FASAT", "FATRN", "CHOCDF", "FIBTG", "SUGAR", "PROCNT", "CHOLE", "NA", "CA", "FE", "VITA_RAE", "VITC"]
        lst = ["ENERC_KCAL", "FAT", "FASAT", "FATRN", "FAMS", "FAPU", "CHOCDF", "FIBTG", "SUGAR", "PROCNT", "CHOLE", "NA", "CA", "MG", "K", "FE", "ZN", "P", "VITA_RAE", "VITC", "THIA", "RIBF", "NIA", "VITB6A", "FOLDFE", "VITB12", "VITD", "TOCPHA", "VITK1", "WATER"]
        
        nutdict = {
            "Nutrient": [nutrients["totalNutrients"][nutcode]["label"] for nutcode in main],
            "Amount": [nutrients["totalNutrients"][nutcode]["quantity"] for nutcode in main],
            "Unit": [nutrients["totalNutrients"][nutcode]["unit"] for nutcode in main],
            "Daily Value": [nutrients["totalDaily"][nutcode]["quantity"] if nutcode not in ["FATRN", "SUGAR"] else 0 for nutcode in main],
